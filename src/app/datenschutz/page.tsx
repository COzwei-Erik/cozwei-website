    ...
    <div className="min-h-screen flex flex-col font-sans bg-white text-gray-900">
      ...
      <main className="flex-1 px-4 py-12 max-w-3xl mx-auto w-full">
        ...
        <div className="prose prose-lg max-w-none text-[#3D405B]">
          ...
          <h2>5. Cookies</h2>
          <p>Wir setzen auf dieser Webseite ausschließlich technisch notwendige Cookies ein, die für die Bereitstellung und sichere Auslieferung der Seite erforderlich sind. Rechtsgrundlage ist Art. 6 Abs. 1 S. 1 lit. f DSGVO; unser berechtigtes Interesse liegt an der technisch einwandfreien und benutzerfreundlichen Darstellung der Webseite. Einwilligungspflichtige Cookies oder Tracking-Dienste werden derzeit nicht eingesetzt.</p>
          <p>Sollten wir künftig nicht-notwendige Dienste (z.&nbsp;B. Webanalyse) einsetzen, holen wir Ihre Einwilligung zuvor über einen Cookie-Banner ein und ergänzen diese Datenschutzerklärung entsprechend. Sie können eine erteilte Einwilligung jederzeit mit Wirkung für die Zukunft im Cookie-Banner widerrufen.</p>

          <h2>6. Webanalyse mit Google Analytics (geplant, nur mit Einwilligung)</h2>
          <p>Sobald wir Google Analytics aktivieren, gilt Folgendes: Wir nutzen Google Analytics, einen Webanalysedienst von Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland. Eingesetzte Cookies ermöglichen eine Analyse der Nutzung unserer Webseite. Google verwendet diese Informationen in unserem Auftrag, um die Nutzung der Webseite auszuwerten, Reports über die Webseitenaktivitäten zusammenzustellen und weitere Dienstleistungen gegenüber uns zu erbringen.</p>
