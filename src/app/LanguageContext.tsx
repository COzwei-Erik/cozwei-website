...
export const translations = {
  de: {
    ...
    insightsSectionTitle: "Blogbeiträge",
    insightsSectionSubtitle: "Drei aktuelle Beiträge aus unserer Arbeit mit Verlagen, öffentlichen Einrichtungen und Unternehmen aller Größen.",
  ...
  en: {
    ...
    insightsSectionTitle: "Blog posts",
    insightsSectionSubtitle: "Three recent posts from our work with publishers, public institutions and companies of all sizes.",
  ...
  pt: {
    ...
    insightsSectionTitle: "Publicações do blog",
    insightsSectionSubtitle: "Três publicações recentes do nosso trabalho com editoras, instituições públicas e empresas de todos os portes.",
