...
export const translations = {
  de: {
    ...
    insightsPost4Date: "Juni 2026",
    insightsPost4Category: "Förderung",
    insightsPost4Title: "Wenn der Mehrkostenansatz entscheidet: Was eine BAFA-Modul-4-Förderung für eine Druckmaschine wirklich bringt",
    insightsPost4Desc: "Bei Modul 4 Premium entscheidet nicht die Investitionssumme, sondern die Referenzmaschine. Eine Beispielrechnung zeigt, wie aus 500.000 € rund 78.000 € Förderung werden.",
    insightsPost5Date: "Juli 2026",
    insightsPost5Category: "CSRD und ESRS",
    insightsPost5Title: "CSRD in der Autoindustrie: Vier Lektionen für kleinere Zulieferer",
    insightsPost5Desc: "Was kleinere Automobilzulieferer aus den ersten Berichten von VW, BMW und Co. nach den ESRS lernen können: 4 Lektionen aus der Berichtssaison 2024/2025.",
    ...
    decarbonCard1Desc: "40 bis 60 % der Beratungskosten für einen Transformationsplan zur Klimaneutralität, maximal 60.000 €, mit Netzwerk-Bonus bis 90.000 €",
    ...
    transfHeroTitle: "BAFA-Transformationsplan: geförderter Fahrplan zur Klimaneutralität",
    transfHeroDesc: "Gefördert werden 40 bis 60 Prozent der Beratungskosten, maximal 60.000 Euro je Plan. Mit Mitgliedschaft in einem Netzwerk der Initiative Energieeffizienz- und Klimaschutz-Netzwerke (IEEKN) steigen Quote um 10 Prozentpunkte und Maximalsumme auf 90.000 Euro.",
    ...
    transfEligMax: "Maximal 60.000 € je Plan, mit Netzwerk-Bonus bis 90.000 €",
    ...
    klimaAuthorRole: "Nachhaltigkeitsberaterin · NKI-Klimaschutzkonzepte",
    klimaAuthorBio: "Marie Bruns ist Nachhaltigkeitsberaterin und betreut bei der COzwei GmbH neben Unternehmenskunden schwerpunktmäßig Klimaschutzkonzepte der NKI. Sie trägt als Umweltingenieurin der RWTH Aachen zudem maßgeblich zur Bewertung von Maßnahmen zur CO₂-Reduktion bei.",
    ...
    klimaRefsEyebrow: "Referenzen · Hochschul-Projekte",
    klimaRefsTitle: "Drei Klimaschutzkonzepte",
    klimaRefsIntro: "Erfolgsfälle aus unserer Zusammenarbeit mit Hochschulen. Von der Datenaufbereitung und ‑erhebung bis zur Veröffentlichung. Maßnahmen entwickelt in enger Abstimmung, damit das Konzept die Institution tatsächlich näher an ihre Nachhaltigkeitsziele bringt.",
    ...
    klimaRefsButtonReport: "Konzept als PDF ansehen",
    klimaRefsButtonPage: "Zur Nachhaltigkeitsseite",
    klimaTags: [
  ...
  en: {
    ...
    insightsPost4Date: "June 2026",
    insightsPost4Category: "Funding",
    insightsPost4Title: "When the incremental-cost approach decides: what a BAFA Module 4 grant really delivers for a printing press",
    insightsPost4Desc: "With Module 4 Premium it is not the investment amount that decides, but the reference machine. A worked example shows how a 500,000 € investment can secure around 78,000 € in funding.",
    insightsPost5Date: "July 2026",
    insightsPost5Category: "CSRD and ESRS",
    insightsPost5Title: "CSRD in the automotive industry: four lessons for smaller suppliers",
    insightsPost5Desc: "What smaller automotive suppliers can learn from the first ESRS reports of VW, BMW and Co.: four lessons from the 2024/2025 reporting season.",
    ...
    decarbonCard1Desc: "40 to 60 % of consulting costs for a transformation plan towards climate neutrality, up to EUR 60,000, with network bonus up to EUR 90,000",
    ...
    transfHeroTitle: "BAFA transformation plan: a funded roadmap to climate neutrality",
    transfHeroDesc: "Funding covers 40 to 60 percent of consulting costs, up to EUR 60,000 per plan. With membership in a network of the German energy efficiency and climate protection networks initiative (IEEKN), the rate rises by 10 percentage points and the cap to EUR 90,000.",
    ...
    transfEligMax: "A maximum of EUR 60,000 per plan, with network bonus up to EUR 90,000",
    ...
    klimaAuthorName: "Marie Bruns",
    klimaAuthorRole: "Sustainability consultant · NKI climate protection concepts",
    klimaAuthorBio: "Marie Bruns is a sustainability consultant at COzwei GmbH and, alongside corporate clients, focuses on NKI climate protection concepts. As an environmental engineer graduating from RWTH Aachen, she also contributes substantially to the assessment of CO₂ reduction measures.",
    ...
    klimaRefsEyebrow: "References · universities projects",
    klimaRefsTitle: "Three climate protection concepts",
    klimaRefsIntro: "Success cases from our partnership with universities. Work we developed end-to-end, from data preparation and collection through to publication. Measures built in close collaboration so the plan can truly move each institution toward its sustainability goals.",
    klimaRefHtwgName: "HTWG Konstanz",
    ...
    klimaRefsButtonReport: "See full report",
    klimaRefsButtonPage: "Visit sustainability page",
    klimaTags: [
  ...
  pt: {
    ...
    insightsPost4Date: "Junho de 2026",
    insightsPost4Category: "Apoios",
    insightsPost4Title: "Quando o método de custos incrementais decide: o que um apoio BAFA Módulo 4 realmente dá para uma máquina de impressão",
    insightsPost4Desc: "No Módulo 4 Premium não é o montante investido que decide, mas a máquina de referência. Um exemplo prático mostra como um investimento de 500.000 € pode garantir cerca de 78.000 € de apoio.",
    insightsPost5Date: "Julho de 2026",
    insightsPost5Category: "CSRD e ESRS",
    insightsPost5Title: "CSRD na indústria automóvel: quatro lições para fornecedores mais pequenos",
    insightsPost5Desc: "O que os fornecedores automóveis mais pequenos podem aprender com os primeiros relatórios da VW, BMW e Co. segundo as ESRS: quatro lições da temporada 2024/2025.",
    ...
    decarbonCard1Desc: "40 a 60 % dos custos de consultoria para um plano de transformação rumo à neutralidade climática, até 60.000 €, com bónus de rede até 90.000 €",
    ...
    transfHeroTitle: "Plano de transformação BAFA: roteiro financiado para a neutralidade climática",
    transfHeroDesc: "São financiados 40 a 60 por cento dos custos de consultoria, no máximo 60.000 euros por plano. Com adesão a uma rede da iniciativa alemã de redes de eficiência energética e proteção climática (IEEKN), a taxa aumenta 10 pontos percentuais e o limite passa a 90.000 euros.",
    ...
    transfEligMax: "No máximo 60.000 € por plano, com bónus de rede até 90.000 €",
    ...
    klimaAuthorName: "Marie Bruns",
    klimaAuthorRole: "Consultora de sustentabilidade · conceitos NKI de proteção climática",
    klimaAuthorBio: "Marie Bruns é consultora de sustentabilidade e, na COzwei GmbH, acompanha, além de clientes empresariais, sobretudo conceitos NKI de proteção climática. Como engenheira ambiental formada na RWTH Aachen, contribui decisivamente para a avaliação de medidas de redução de CO₂.",
    ...
    klimaRefsEyebrow: "Referências · projetos universitários",
    klimaRefsTitle: "Três conceitos de proteção climática",
    klimaRefsIntro: "Casos de sucesso da nossa parceria com universidades. Trabalho desenvolvido de ponta a ponta, da preparação e recolha de dados até à publicação. Medidas construídas em estreita colaboração para que o conceito leve a instituição mais perto das suas metas de sustentabilidade.",
    klimaRefHtwgName: "HTWG Konstanz",
    ...
    klimaRefsButtonReport: "Ver relatório completo",
    klimaRefsButtonPage: "Visitar página de sustentabilidade",
    klimaTags: [
