...
export const translations = {
  de: {
    ...
    aboutHeroDesc: "Nachhaltigkeit aus der Industrie für die Industrie. Aus unserer Zeit als Umwelt- und Nachhaltigkeitsmanager der Porsche AG bringen wir Dekarbonisierung dorthin, wo sie messbar wird: in die Bilanz, in die Investitionsentscheidung, in die Anlage. Vermeidungskostenoptimiert, umsetzungsorientiert: Weniger PowerPoint, mehr machen.",
  ...
  en: {
    ...
    aboutHeroDesc: "Sustainability from industry, for industry. From our time as environmental and sustainability managers at Porsche AG, we bring decarbonisation to where it becomes measurable: into the balance sheet, into the investment decision, into the plant. Abatement-cost optimised, implementation focused: less PowerPoint, more action.",
  ...
  pt: {
    ...
    aboutHeroDesc: "Sustentabilidade da indústria, para a indústria. Do nosso tempo como gestores de ambiente e sustentabilidade na Porsche AG, trazemos a descarbonização para onde se torna mensurável: ao balanço, à decisão de investimento, à instalação. Otimizada em custos de redução, orientada para a implementação: menos PowerPoint, mais ação.",
