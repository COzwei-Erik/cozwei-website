        ...
        <section id="team-section" className="w-full py-16 relative overflow-x-hidden">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-center place-items-stretch h-full">
              {/* Card 1 */}
              <div className="flex flex-row items-center bg-white rounded-2xl border border-[#81B29A]/30 p-6 gap-6 min-h-[220px] transition-all duration-300 hover:scale-105 hover:border-2 hover:border-[#81B29A] hover:ring-2 hover:ring-[#81B29A]/30 overflow-hidden group">
                <Image src="/Pictures/Christian.png" alt="Christian Philippen" width={180} height={180} className="rounded-xl object-cover flex-shrink-0" />
              ...
              {/* Card 2 */}
              <div className="flex flex-row items-center bg-white rounded-2xl border border-[#81B29A]/30 p-6 gap-6 min-h-[220px] transition-all duration-300 hover:scale-105 hover:border-2 hover:border-[#81B29A] hover:ring-2 hover:ring-[#81B29A]/30 overflow-hidden group">
                <Image src="/Pictures/Erik.png" alt="Erik Jakob" width={180} height={180} className="rounded-xl object-cover flex-shrink-0" />
                <div className="flex flex-col justify-center flex-1">
              ...
              {/* Card 3: Alina Krut */}
              <div className="flex flex-row items-center bg-white rounded-2xl border border-[#81B29A]/30 p-6 gap-6 min-h-[220px] transition-all duration-300 hover:scale-105 hover:border-2 hover:border-[#81B29A] hover:ring-2 hover:ring-[#81B29A]/30 overflow-hidden group">
                <Image src="/Pictures/Alina_V2.png" alt="Alina Krut" width={180} height={180} className="rounded-xl object-cover flex-shrink-0" />
                <div className="flex flex-col justify-center flex-1">
              ...
              <div className="flex flex-row items-center bg-white rounded-2xl border border-[#81B29A]/30 p-6 gap-6 min-h-[220px] transition-all duration-300 hover:scale-105 hover:border-2 hover:border-[#81B29A] hover:ring-2 hover:ring-[#81B29A]/30 overflow-hidden group">
                <Image src="/Pictures/Dominik_V2.png" alt="Dominik Enger" width={180} height={180} className="rounded-xl object-cover flex-shrink-0" />
                <div className="flex flex-col justify-center flex-1">
              ...
              <div className="flex flex-row items-center bg-white rounded-2xl border border-[#81B29A]/30 p-6 gap-6 min-h-[220px] transition-all duration-300 hover:scale-105 hover:border-2 hover:border-[#81B29A] hover:ring-2 hover:ring-[#81B29A]/30 overflow-hidden group">
                <Image src="/Pictures/Louis_V2 (1).png" alt="Louis Noel Tallner" width={180} height={180} className="rounded-xl object-cover flex-shrink-0" />
                <div className="flex flex-col justify-center flex-1">
              ...
              {/* Card 6: Ronan Maier */}
              <div className="flex flex-row items-center bg-white rounded-2xl border border-[#81B29A]/30 p-6 gap-6 min-h-[220px] transition-all duration-300 hover:scale-105 hover:border-2 hover:border-[#81B29A] hover:ring-2 hover:ring-[#81B29A]/30 overflow-hidden group">
                <Image src="/Pictures/65f96a3129c25914fbad539c_2024-03-14__DSC8933-NEF_2024-03-10_DXO.png" alt="Ronan Maier" width={180} height={180} className="rounded-xl object-cover flex-shrink-0" />
                <div className="flex flex-col justify-center flex-1">
