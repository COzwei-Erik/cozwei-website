      ...
      <div className="flex items-center justify-between px-6 py-1">
        ...
        <ul className="hidden md:flex gap-6 lg:gap-8 items-center">
          ...
          <li className="relative" onMouseEnter={() => open("branchen")} onMouseLeave={scheduleClose}>
            ...
            {openMenu === "branchen" && (
              <ul
                className="absolute left-1/2 -translate-x-1/2 mt-3 min-w-[260px] bg-white border border-[#81B29A]/30 rounded-2xl shadow-lg py-2 z-50"
