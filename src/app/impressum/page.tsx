    ...
    <div className="min-h-screen flex flex-col font-sans bg-white text-gray-900">
      ...
      <main className="flex-1 px-4 py-12 max-w-3xl mx-auto w-full">
        ...
        <div className="prose prose-lg max-w-none text-[#3D405B]">
          ...
          <p>Eintragung im Handelsregister<br />Registergericht: Stuttgart<br />Registernummer: HRB 787112</p>
          <h2>Umsatzsteuer-ID</h2>
          <p>Umsatzsteuer-Identifikationsnummer gemäß § 27 a Umsatzsteuergesetz:<br />DE358028300</p>
